...
const branches = [
  ...
  },
  {
    ...
    href: "/free-notes/gate-in",
    icon: Network,
    topicCount: 9,
  },
];

export default function FreeNotesIndexPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0e0f14] text-[#E5E7EB] font-sans selection:bg-[#6C63FF]/30 overflow-hidden pb-24">
      
      {/* Ambient Background Glows */}
      <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#6C63FF]/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-4 pt-24 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#6C63FF]/30 bg-[#6C63FF]/10 text-xs font-bold uppercase tracking-widest text-[#6C63FF] mb-6 shadow-[0_0_15px_rgba(108,99,255,0.2)]"
          >
            <BookOpen size={14} /> Comprehensive Study Material
          </motion.div>
          ...
          >
            Premium Topper <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6C63FF] to-[#818CF8]">Notes</span>
          </motion.h1>
          ...
          >
            Access highly curated, digitally optimized handwritten notes and short revision sheets designed specifically for your engineering branch.
          </motion.p>
        </div>
                ...
                <div>
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="flex items-center gap-1.5 rounded-full bg-[#0B0C10] border border-gray-800 px-3 py-1 text-xs font-medium text-[#9CA3AF]">
                      <FileText size={12} /> {branch.topicCount} Subjects
                    </div>
                  </div>
                  ...
                  <p className="text-sm text-[#9CA3AF] mb-8 leading-relaxed">
                    Complete subject-wise notes, formula sheets, and quick revision mind-maps for {branch.short}.
                  </p>
                </div>
